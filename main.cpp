...
Player createrPlayer(){
    ...
    Player p;
    std::cout<<"\n Choose profession:\n"
            <<" 1. Warrior(HP:150  MP:50  ATK:22)\n"
            <<" 2. Mage(HP: 100  MP:120  ATK:15)\n"
            <<" 3. Thief(HP:120  MP:70  ATK:18)\n";
    int cls = getInput(1,3);
    switch (cls){
        case 1:
            p = Player(name, 150, 50, 22);
            p.skills.push_back(Skill("skill 1", 35, 20));
            p.skills.push_back(Skill("skill 2", 50, 35));
            break;
        case 2:
        ...
        case 3:
            ...
            p.skills.push_back(Skill("backstab", 80, 45));
            p.skills.push_back(Skill("skill 2", 50, 30));
            break;
    }
    ...
    //player.items.push_back(Item("strength potion", ItemType::ATTACK_UP, 50, 1));
    std::cout<<"\ngame start!\n";
    pause(800);
    return p;
...
int main(){
    ...
    Monster monster1("dragon",80, 14, 30);
    ...
    Monster monster2("big monster", 100, 20, 40);
    ...
    shop(player);
    Monster final("Bowser", 150, 25, 50);
